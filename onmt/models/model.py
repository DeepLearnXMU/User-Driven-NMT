...
class NMTModel(nn.Module):
    ...
    def forward(self, src, tgt, lengths, bptt=False, with_align=False,
                history_cache=None, current_cache=None):
        ...
        Args:
            ...
            history_cache (Tensor): keywords in history cache
            current_cache (Tensor): keywords in current cache
